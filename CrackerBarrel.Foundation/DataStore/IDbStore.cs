...
namespace CrackerBarrel.Foundation.DataStore
{
    public interface IDbStore : IDataStore
    {
        ...
        IEnumerable<T> GetMultiMap<T, T2>(string sql, Func<T, T2, T> func, object param = null);
        IEnumerable<T> GetMultiMap<T, T2, T3>(string sql, Func<T, T2, T3, T> func, object param = null);
